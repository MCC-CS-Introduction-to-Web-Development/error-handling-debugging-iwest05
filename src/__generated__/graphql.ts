...
export type GetAllAlbumsQuery = { albums: { data: Array<{ id: string | null, title: string | null, user: { id: string | null, name: string | null } | null } | null> | null } | null };
 ...
 * });
 */
export function useGetAllAlbumsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetAllAlbumsQuery, GetAllAlbumsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetAllAlbumsQuery, GetAllAlbumsQueryVariables>(GetAllAlbumsDocument, options);
      }
export function useGetAllAlbumsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetAllAlbumsQuery, GetAllAlbumsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetAllAlbumsQuery, GetAllAlbumsQueryVariables>(GetAllAlbumsDocument, options);
        }
// @ts-ignore
export function useGetAllAlbumsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetAllAlbumsQuery, GetAllAlbumsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetAllAlbumsQuery, GetAllAlbumsQueryVariables>;
// @ts-ignore
export function useGetAllAlbumsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetAllAlbumsQuery, GetAllAlbumsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetAllAlbumsQuery | undefined, GetAllAlbumsQueryVariables>;
export function useGetAllAlbumsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetAllAlbumsQuery, GetAllAlbumsQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetAllAlbumsQuery, GetAllAlbumsQueryVariables>(GetAllAlbumsDocument, options);
        }
...
export type GetAllAlbumsSuspenseQueryHookResult = ReturnType<typeof useGetAllAlbumsSuspenseQuery>;
export type GetAllAlbumsQueryResult = ApolloReactHooks.QueryResult<GetAllAlbumsQuery, GetAllAlbumsQueryVariables>;