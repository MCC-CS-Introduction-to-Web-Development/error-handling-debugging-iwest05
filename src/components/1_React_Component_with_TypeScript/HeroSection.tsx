    ...
    return (
        <div className="bg-[#f5f5f5]">
            ...
            <div className="flex gap-8 px-10 py-16 max-w-6xl mx-auto justify-center flex-wrap">
                ...
                {/* Apollo GraphQL Albums Card */}
                <div className="bg-white p-5 rounded-lg text-center w-72 shadow-md transition-transform hover:-translate-y-1 flex flex-col items-center justify-center gap-4">
                    <h3 className="text-[#2d2d7f] text-base font-semibold">Apollo GraphQL</h3>
                    <Link
                        href="/apolloAlbums"
                        className="bg-[#2d2d7f] text-white px-6 py-2 rounded font-semibold text-sm hover:bg-[#1f1f5a] transition-colors"
                    >
                    ...
                    <p className="text-gray-500 text-sm">Assignment 9</p>
                </div>
                {/* Custom Hooks Card */}
                <div className="bg-white p-5 rounded-lg text-center w-72 shadow-md transition-transform hover:-translate-y-1 flex flex-col items-center justify-center gap-4">
                    <h3 className="text-[#2d2d7f] text-base font-semibold">Custom React Hooks</h3>
                    <Link
                        href="/customHooks"
                        className="bg-[#2d2d7f] text-white px-6 py-2 rounded font-semibold text-sm hover:bg-[#1f1f5a] transition-colors"
                    >
                    ...
                    <p className="text-gray-500 text-sm">Assignment 10</p>
                </div>
                {/* External Pages Card */}
                <div className="bg-white p-5 rounded-lg text-center w-72 shadow-md transition-transform hover:-translate-y-1 flex flex-col items-center justify-center gap-4">
